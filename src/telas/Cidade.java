...
public class Cidade extends javax.swing.JDialog {
    ...
    public Cidade(java.awt.Frame parent, boolean modal) {
        ...
        this.preencherTabela("select * from cidade order by nome, uf");
    }
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(jTextFieldPesqCid, javax.swing.GroupLayout.PREFERRED_SIZE, 179, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(18, 18, 18)
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        if (flag == 0) {
            ...
            conex.conexao();
            conex.executaSQL("select * from cidade where nome='" + nome + "' and uf='" + uf + "'");
            try {
                conex.rs.first();
                cidade.setCodcd(conex.rs.getInt("codcd"));
                jTextFieldNome.setText(conex.rs.getString("nome"));
                jComboBoxUF.setSelectedItem(String.valueOf(conex.rs.getString("uf")));
