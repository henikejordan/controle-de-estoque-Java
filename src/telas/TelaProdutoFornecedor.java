 ...
 * @author Henike
 */
public class TelaProdutoFornecedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produto por fornecedor");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jComboBoxForn, 0, 122, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
    ...
    private void jButtonOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonOKActionPerformed
        ...
        try {
            ...
            conex.executaSQL("select vpr.codp,"
                    ...
                    + " where vpd.data <= '" + data + "' and vpd.nome_fornecedor = '" + jComboBoxForn.getSelectedItem() + "'"
            ...
            parametros.put("Parameter2", jComboBoxForn.getSelectedItem());
            JasperPrint jpPrint = JasperFillManager.fillReport("iReport/relatorioBrancoProdutoFornecedor.jasper", parametros, relatResul);// Indica o caminho para pegar o modelo do relatório
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TelaProdutoFornecedor().setVisible(true);
        });
    }
