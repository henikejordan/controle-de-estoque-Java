...
public class TelaAlterarCidade extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TelaDetalhesCategoria
     *
     * @param nome
     * @param uf
     */
    public TelaAlterarCidade(String nome, String uf) {
        initComponents();
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(494, 256));
    ...
    private void jButtonAjudaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAjudaActionPerformed
        new TelaAjudaAltCidade().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAlterarCidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        //</editor-fold>
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TelaAlterarCidade().setVisible(true);
        });
    }
